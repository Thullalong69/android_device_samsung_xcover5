...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/vic0_registers.xml:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/vic0_registers.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/xcover5/xcover5-vendor.mk)